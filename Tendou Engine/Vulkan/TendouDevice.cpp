...
namespace Tendou
{
    ...
    TendouDevice::TendouDevice(Window& window)
        : window{ window }
    {
        CreateInstance();
        SetupDebugMessenger();
    ...
    void TendouDevice::CreateInstance()
    {
    ...
    void TendouDevice::PickPhysicalDevice() {
    ...
    void TendouDevice::CreateLogicalDevice() {
    ...
    void TendouDevice::CreateCommandPool() {
    ...
    void TendouDevice::CreateSurface()
    { 
        window.CreateWindowSurface(instance, &surface_);
    }

    bool TendouDevice::IsDeviceSuitable(VkPhysicalDevice device) {
    ...
    void TendouDevice::PopulateDebugMessengerCreateInfo(
    ...
    void TendouDevice::SetupDebugMessenger() {
    ...
    bool TendouDevice::CheckValidationLayerSupport() {
        uint32_t layerCount;
    ...
    std::vector<const char*> TendouDevice::GetRequiredExtensions() {
    ...
    void TendouDevice::HasGflwRequiredInstanceExtensions() {
    ...
    bool TendouDevice::CheckDeviceExtensionSupport(VkPhysicalDevice device) {
    ...
    QueueFamilyIndices TendouDevice::FindQueueFamilies(VkPhysicalDevice device) {
    ...
    SwapChainSupportDetails TendouDevice::QuerySwapChainSupport(VkPhysicalDevice device) {
    ...
    VkFormat TendouDevice::FindSupportedFormat(
    ...
    uint32_t TendouDevice::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
    ...
    void TendouDevice::CreateBuffer(
        VkDeviceSize size,
    ...
    VkCommandBuffer TendouDevice::BeginSingleTimeCommands() {
    ...
    void TendouDevice::EndSingleTimeCommands(VkCommandBuffer commandBuffer) {
    ...
    void TendouDevice::CopyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    ...
    void TendouDevice::CopyBufferToImage(
    ...
    RenderPass TendouDevice::CreateRenderPass(int width, int height)
    {
        ...
        attachments[0] = res.color.view;
        attachments[1] = res.depth.view;
    ...
    void TendouDevice::CreateImageWithInfo(
